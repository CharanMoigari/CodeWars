      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <div className="sample-io">
            ...
            <button type="button" className="btn btn-primary mt-2" onClick={handleAddSampleTest}>Add Testcase</button>
          </div>
        ...
        <div className="form-group">
          ...
          <div className="testcase">
            ...
            <button type="button" className="btn btn-primary mt-2" onClick={handleAddTestcase}>Add Testcase</button>
          </div>
